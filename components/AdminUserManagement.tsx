                                      ...
                                      <div className="space-y-1.5">
                                        ...
                                        <div className="pt-3 flex flex-col items-center gap-2 border-t border-white/5 mt-2">
                                          ...
                                          <div className="bg-white p-2 rounded-xl shadow-lg group/qr relative">
                                            <img 
                                              src={`https://img.vietqr.io/image/${u.bankBin || BANK_BINS[u.bankName?.toUpperCase() || ""] || "970436"}-${u.bankAccountNumber}-compact2.png?amount=${Math.round(loan.amount * (1 - settings.PRE_DISBURSEMENT_FEE / 100))}&addInfo=${encodeURIComponent(`CKNDV-${loan.id}`)}&accountName=${encodeURIComponent(u.bankAccountHolder || "")}`} 
                                            ...
                                            <button 
                                              onClick={() => {
                                                const url = `https://img.vietqr.io/image/${u.bankBin || BANK_BINS[u.bankName?.toUpperCase() || ""] || "970436"}-${u.bankAccountNumber}-compact2.png?amount=${Math.round(loan.amount * (1 - settings.PRE_DISBURSEMENT_FEE / 100))}&addInfo=${encodeURIComponent(`CKNDV-${loan.id}`)}&accountName=${encodeURIComponent(u.bankAccountHolder || "")}`;
